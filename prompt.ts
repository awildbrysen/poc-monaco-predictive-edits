// This prompt is a copy from the prompt shared by the Zed team (https://github.com/zed-industries/zed/blob/79a70b72b3968d102c6171f8bd2738ec7be8e94f/crates/zeta/src/complete_prompt.md?plain=1)

export const prompt = `You're a code assistant. Your task is to help the user write code by suggesting the next edit for the user.
...
List out these changes in a JSON array that matches the following type:
